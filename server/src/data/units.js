export const units = [
  {
    name: "KWH",
    description:
      "A kilowatt-hour is a unit of energy equal to one kilowatt of power sustained for one hour or to 3600 kilojoules (3.6 megajoules).",
  },
  {
    name: "TKM",
    description:
  ...
  {
    name: "H",
    description: "A hour unit gives emissions for one hour operation.",
  },
  {
    name: "PKM",
    description:
